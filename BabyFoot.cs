...
namespace baby_foot {
    ...
    public partial class BabyFoot : Form {
        ...
        public void InitTeams() {
            ...
            this.teams[0] = new Team(this, match.Participates[0], Brushes.Red, 0);
            this.teams[1] = new Team(this, match.Participates[1], Brushes.Blue, 1);
        }
        ...
        private void area_Paint(object sender, PaintEventArgs e) {
            ...
            foreach (Team team in teams) {
                ...
                foreach (BabyFootPlayer player in team.players) {
                    if (position == team.Position) g.FillPolygon(Brushes.Black, player.GetCurser());
            ...
            // Create a ball
            g.FillEllipse(Brushes.Blue, (int) ball.X, (int) ball.Y, ball.GetDiametre(), ball.GetDiametre());
        }
